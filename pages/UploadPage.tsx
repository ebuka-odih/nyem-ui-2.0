        ...
        {activeTab === 'collection' ? (
          ...
          >
            ...
            <div className="space-y-6">
              ...
              {/* Redesigned Side-by-Side Asking Price & Type */}
              <div className="space-y-2">
                <label className="text-[10px] font-black text-neutral-500 uppercase tracking-widest px-1">Asking Price</label>
                <div className="flex gap-3 h-20">
                  {/* Amount Input */}
                  <div className="flex-[2] flex bg-white border border-neutral-300 rounded-[1.5rem] focus-within:border-neutral-900 focus-within:ring-4 focus-within:ring-neutral-900/5 transition-all overflow-hidden shadow-sm items-stretch">
                    <div className="flex items-center justify-center pl-6 pr-3 border-r border-neutral-100 bg-neutral-50/30">
                      <span className="text-neutral-900 font-black text-xl">₦</span>
                    </div>
                    <input 
                      type="text" 
                      value={price} 
                  ...
                  <div className="flex-1 relative">
                    <button 
                      ...
                      className="w-full h-full flex items-center justify-between px-6 bg-white border border-neutral-300 rounded-[1.5rem] transition-all hover:bg-neutral-50 active:scale-95 shadow-sm"
                    >
                      <div className="flex flex-col items-start min-w-0">
                        <span className="text-[7px] font-black text-neutral-400 uppercase tracking-[0.2em] leading-none mb-1">TYPE</span>
                        <span className="text-[10px] font-black text-neutral-900 uppercase tracking-widest truncate">{priceType}</span>
                      </div>
                      <ChevronDown size={14} className={`text-neutral-300 transition-transform ${showPriceTypeDropdown ? 'rotate-180' : ''}`} strokeWidth={3} />
                    </button>
